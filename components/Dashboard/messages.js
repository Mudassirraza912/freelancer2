...
export default class Messages extends React.Component {
    ...
    render() {
        const { users, selectedId, currentUser, renderUid, messages, msgText } = this.state
        ...
        justifyContent: 'center', marginTop : 50}}>
                            ...
                            <View style={{ bottom: 70}} >
                                <Input rightIcon={<Button icon={<Icon name='send' color="white" />}  onPress={this.sendMessage} />}
                                        ...
                                        if (value.senderId === currentUser) {
                                            return (<View>
                                                ...
                                                <View style={{marginBottom:10}}>
                                                    <ListItem onPress={this.fetchMessage.bind(this, value.revieverId, value.revieverName, value.revieverPhotoUrl)}
                                                        key={index}
